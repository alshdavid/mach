            ...
            if !is_empty && args.is_empty() {
              if let Expr::Lit(Lit::Str(Str { span, value, raw })) = *obj {
                match *expr {
                  ...
                  _ => {
                    obj = Box::new(Expr::Lit(Lit::Str(Str { span, raw, value })));
                  }
                }
              }
            }
              ...
              obj = if self.c.ignore_to_primitive {
                ...
                Box::new(Expr::Call(CallExpr {
                  ...
                  callee: MemberExpr {
                    span: DUMMY_SP,
                    obj,
                    prop: MemberProp::Ident(Ident::new("concat".into(), expr_span)),
                  }
                  .as_callee(),
            ...
            let data_decl = VarDecl {
              ...
              decls: vec![VarDeclarator {
                ...
                init: Some(Box::new(Expr::Call(CallExpr {
                  ...
                  args: {
                    let has_escape = tpl.quasis.iter().any(|s| s.raw.contains('\\'));
