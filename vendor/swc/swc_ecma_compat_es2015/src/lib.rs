...
use swc_common::Mark;
use swc_ecma_compat_common::regexp::regexp;
use swc_ecma_compat_common::regexp::{self};
use swc_ecma_visit::Fold;

pub use self::arrow::arrow;
pub use self::block_scoped_fn::block_scoped_functions;
pub use self::block_scoping::block_scoping;
pub use self::classes::classes;
pub use self::computed_props::computed_properties;
pub use self::destructuring::destructuring;
pub use self::duplicate_keys::duplicate_keys;
pub use self::for_of::for_of;
pub use self::function_name::function_name;
pub use self::instanceof::instance_of;
pub use self::new_target::new_target;
pub use self::object_super::object_super;
pub use self::parameters::parameters;
pub use self::shorthand_property::shorthand;
pub use self::spread::spread;
pub use self::sticky_regex::sticky_regex;
pub use self::template_literal::template_literal;
pub use self::typeof_symbol::typeof_symbol;
