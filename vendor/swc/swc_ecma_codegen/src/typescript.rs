  ...
  W: WriteJs,
{
  ...
  #[emitter]
  fn emit_ts_call_signature_decl(
    &mut self,
  ...
  #[emitter]
  fn emit_ts_constructor_signature_decl(
    &mut self,
  ...
  #[emitter]
  fn emit_ts_expr_with_type_args(
    &mut self,
  ...
  #[emitter]
  fn emit_ts_external_module_ref(
    &mut self,
  ...
  #[emitter]
  fn emit_ts_fn_or_constructor_type(
    &mut self,
  ...
  #[emitter]
  fn emit_ts_index_accessed_type(
    &mut self,
  ...
  #[emitter]
  fn emit_ts_type_param_instantiation(
    &mut self,
  ...
  #[emitter]
  fn emit_ts_union_or_intersection_type(
    &mut self,
