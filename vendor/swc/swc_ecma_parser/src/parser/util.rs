...
impl Context {
  ...
  pub fn is_reserved_word(
    ...
    match &**word {
      ...
      | "default" | "do" | "export" | "else" | "finally" | "for" | "function" | "if" | "return"
      | "switch" | "throw" | "try" | "var" | "const" | "while" | "with" | "new" | "this"
      | "super" | "class" | "extends" | "import" | "in" | "instanceof" | "typeof" | "void"
      | "delete" => true,
...
pub(super) trait ExprExt {
  ...
  fn is_valid_simple_assignment_target(
    &self,
    strict: bool,
  ) -> bool {
    match self.as_expr() {
