...
use super::comments_buffer::BufferedComment;
use super::input::Input;
use super::whitespace::SkipWhitespace;
use super::Char;
use super::LexResult;
use super::Lexer;
use crate::error::Error;
use crate::error::SyntaxError;
use crate::lexer::comments_buffer::BufferedCommentKind;
use crate::Tokens;
...
impl<'a> Lexer<'a> {
 ...
 start = {}, end = {}",
  ...
  #[cold]
  #[inline(never)]
  pub(super) fn emit_strict_mode_error(
    &mut self,
    start: BytePos,
    kind: SyntaxError,
  ) {
  ...
  #[cold]
  #[inline(never)]
  pub(super) fn emit_strict_mode_error_span(
    &mut self,
    span: Span,
    kind: SyntaxError,
  ) {
  ...
  #[cold]
  #[inline(never)]
  pub(super) fn emit_module_mode_error(
    &mut self,
    start: BytePos,
    kind: SyntaxError,
  ) {
  ...
  #[cold]
  #[inline(never)]
  pub(super) fn emit_module_mode_error_span(
    &mut self,
    span: Span,
    kind: SyntaxError,
  ) {
