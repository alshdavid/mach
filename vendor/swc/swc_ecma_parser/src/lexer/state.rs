...
use super::comments_buffer::BufferedCommentKind;
use super::Context;
use super::Input;
use super::Lexer;
...
impl TokenContexts {
  ...
  fn is_brace_block(
    ...
    match prev {
      ...
      //      };
      //  }
      Some(TokenType::Keyword(Keyword::Return)) | Some(TokenType::Keyword(Keyword::Yield)) => {
...
#[cfg(test)]
pub(crate) fn lex_module_errors(
  syntax: Syntax,
  s: &'static str,
) -> Vec<Error> {
