...
use crate::module_decl_strip::Export;
use crate::module_decl_strip::ExportKV;
use crate::module_decl_strip::Link;
use crate::module_decl_strip::LinkFlag;
use crate::module_decl_strip::LinkItem;
use crate::module_decl_strip::LinkSpecifierReducer;
use crate::module_decl_strip::ModuleDeclStrip;
use crate::module_ref_rewriter::rewrite_import_bindings;
...
use crate::util::define_es_module;
use crate::util::emit_export_stmts;
use crate::util::local_name_for_src;
use crate::util::prop_name;
use crate::util::use_strict;
use crate::util::ImportInterop;
use crate::util::VecStmtLike;
  ...
  C: Comments,
{
  fn handle_import_export(
    ...
    link.into_iter().for_each(
      |(src, LinkItem(src_span, link_specifier_set, mut link_flag))| {
        ...
        let is_lazy = decl_mod_ident && !link_flag.export_star() && self.config.lazy.is_lazy(&src);
        ...
        let import_expr = {
          match import_interop {
            ...
            ImportInterop::Node if link_flag.namespace() => helper_expr!(interop_require_wildcard)
  ...
  /// ```
  fn emit_lexer_exports_init(
    &mut self,
    export_id_list: &[ExportKV],
  ) -> Option<Stmt> {
