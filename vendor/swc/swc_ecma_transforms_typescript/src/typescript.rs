...
use swc_ecma_ast::*;
use swc_ecma_transforms_react::parse_expr_for_jsx;
use swc_ecma_transforms_react::JsxDirectives;
...
use crate::strip_import_export::StripImportExport;
use crate::strip_type::StripType;
