...
use super::DiagnosticStyledString;
use super::Handler;
use super::Level;
...
impl<'a> DiagnosticBuilder<'a> {
  ...
  pub fn buffer(
    mut self,
    buffered_diagnostics: &mut Vec<Diagnostic>,
  ) {
  ...
  pub fn span_suggestion_short_with_applicability(
    ...
    self
      .diagnostic
      .span_suggestion_short_with_applicability(sp, msg, suggestion, applicability);
    self
  }

  pub fn allow_suggestions(
    &mut self,
    allow: bool,
  ) -> &mut Self {
