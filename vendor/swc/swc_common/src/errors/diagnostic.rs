...
impl DiagnosticStyledString {
  ...
  pub fn push_normal<S: Into<String>>(
    &mut self,
    t: S,
  ) {
  ...
  pub fn push_highlighted<S: Into<String>>(
    &mut self,
    t: S,
  ) {
...
impl Diagnostic {
  ...
  pub fn is_error(&self) -> bool {
    match self.level {
      Level::Bug | Level::Fatal | Level::PhaseFatal | Level::Error | Level::FailureNote => true,
  ...
  pub fn span_label<T: Into<String>>(
    &mut self,
    span: Span,
    label: T,
  ) -> &mut Self {
  ...
  pub fn set_span<S: Into<MultiSpan>>(
    &mut self,
    sp: S,
  ) -> &mut Self {
    self.span = sp.into();
  ...
  /// message".
  pub fn copy_details_not_message(
    &mut self,
    from: &Diagnostic,
  ) {
