...
pub use self::diagnostic::DiagnosticId;
pub use self::diagnostic::DiagnosticStyledString;
pub use self::diagnostic::SubDiagnostic;
...
use crate::syntax_pos::FileLinesResult;
use crate::syntax_pos::FileName;
use crate::syntax_pos::Loc;
use crate::syntax_pos::MultiSpan;
use crate::syntax_pos::Span;
use crate::syntax_pos::NO_EXPANSION;
use crate::SpanSnippetError;
...
impl Handler {
  ...
  pub fn set_continue_after_error(
    &self,
  ...
  pub fn span_bug<S: Into<MultiSpan>>(
    &self,
    sp: S,
    msg: &str,
  ) -> ! {
  ...
  pub fn span_bug_no_panic<S: Into<MultiSpan>>(
    &self,
    sp: S,
    msg: &str,
  ) {
  ...
  pub fn span_unimpl<S: Into<MultiSpan>>(
    &self,
    sp: S,
    msg: &str,
  ) -> ! {
  ...
  pub fn force_print_db(
    &self,
    mut db: DiagnosticBuilder<'_>,
  ) {
