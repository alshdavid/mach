...
extern "C" {
  ...
  fn __mark_set_builtin_proxy(
    self_mark: u32,
    is_builtin: u32,
  );
  fn __syntax_context_apply_mark_proxy(
    self_syntax_context: u32,
    mark: u32,
  ) -> u32;
  ...
  fn __mark_is_descendant_of_proxy(
    self_mark: u32,
    ancestor: u32,
    allocated_ptr: i32,
  );
  fn __mark_least_ancestor(
    a: u32,
    b: u32,
    allocated_ptr: i32,
  );
  fn __syntax_context_remove_mark_proxy(
    self_mark: u32,
    allocated_ptr: i32,
  );
}
...
impl SyntaxContext {
  ...
  fn apply_mark_internal(
    ...
    HygieneData::with(|data| {
      ...
      let opaque_and_semitransparent = syntax_contexts[self.0 as usize].opaque_and_semitransparent;
