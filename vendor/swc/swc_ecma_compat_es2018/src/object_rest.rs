...
impl ObjectRest {
  fn insert_var_if_not_empty(
    &mut self,
    idx: usize,
    mut decl: VarDeclarator,
  ) {
  ...
  fn fold_rest(
    ...
    let ObjectPat {
      ...
      Pat::Assign(n) => {
        ...
        let left =
          Box::new(self.fold_rest(index, *left, obj, use_expr_for_assign, use_member_for_array));
