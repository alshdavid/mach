...
impl Scope {
    ...
    R: Renamer,
  {
    ...
    self.rename_one_scope_in_normal_mode(renamer, to, previous, reverse, queue, preserved_symbols);

    for child in &mut self.children {
      child.rename_in_normal_mode(renamer, to, &Default::default(), reverse, preserved_symbols);
    }
  }
