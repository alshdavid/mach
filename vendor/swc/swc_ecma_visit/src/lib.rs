...
use swc_visit::Repeat;
use swc_visit::Repeated;
...
macro_rules! noop_fold_type {
  ($name:ident, $N:tt) => {
    fn $name(
      &mut self,
      node: $crate::swc_ecma_ast::$N,
    ) -> $crate::swc_ecma_ast::$N {
      node
    }
  };
  () => {
...
macro_rules! visit_obj_and_computed {
  () => {
    fn visit_member_expr(
      &mut self,
      n: &$crate::swc_ecma_ast::MemberExpr,
    ) {
    ...
    fn visit_super_prop_expr(
      &mut self,
      n: &$crate::swc_ecma_ast::SuperPropExpr,
    ) {
...
macro_rules! visit_mut_obj_and_computed {
  () => {
    fn visit_mut_member_expr(
      &mut self,
      n: &mut $crate::swc_ecma_ast::MemberExpr,
    ) {
    ...
    fn visit_mut_jsx_member_expr(
      &mut self,
      n: &mut $crate::swc_ecma_ast::JSXMemberExpr,
    ) {
      n.obj.visit_mut_with(self);
    }
    ...
    fn visit_mut_super_prop_expr(
      &mut self,
      n: &mut $crate::swc_ecma_ast::SuperPropExpr,
    ) {
