...
- [Resolver](https://parceljs.org/plugin-system/resolver/) (partial)
- [Transformer](https://parceljs.org/plugin-system/transformer/) (in progress)
- [Reporter](https://parceljs.org/plugin-system/reporter/) (todo)
- [Namer](https://parceljs.org/plugin-system/namer/) (todo)
