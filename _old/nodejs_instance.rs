...
// impl<DataTo: ipc::DataTo, DataFrom: ipc::DataFrom> NodejsInstance<DataTo, DataFrom> {
//   pub fn new(nodejs_worker: Arc<NodejsWorkerIpc<DataTo, DataFrom>>) -> Self {
//     // let messages = Arc::new(Mutex::new(HashMap::<u32, Sender<Vec<u8>>>::new()));

//     // let (tx_write, rx_write) = channel::<(usize, DataTo)>();
//     // let worker_write = nodejs_worker.clone();
//     // thread::spawn(move || {
//     //   while let Ok(data) = rx_write.recv() {
//     //     worker_write.send(data);
//     //   }
//     // });
