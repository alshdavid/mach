...
use crate::deno_cli::args::BundleFlags;
...
use crate::deno_cli::graph_util::error_for_any_npm_specifier;
use crate::deno_cli::util;
...
pub async fn bundle(
  ...
  if let Some(watch_flags) = &bundle_flags.watch {
    util::file_watcher::watch_func(
      flags,
      util::file_watcher::PrintConfig::new("Bundle", !watch_flags.no_clear_screen),
...
fn bundle_module_graph(
  ...
  deno_emit::bundle_graph(
    ...
    deno_emit::BundleOptions {
      ...
      emit_options: crate::deno_cli::args::ts_config_to_emit_options(ts_config_result.ts_config),
