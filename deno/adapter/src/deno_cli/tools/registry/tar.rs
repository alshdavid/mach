...
use crate::deno_cli::tools::registry::paths::PackagePath;
...
pub fn create_gzipped_tarball(
  ...
  let file_patterns =
    file_patterns.unwrap_or_else(|| FilePatterns::new_with_base(dir.to_path_buf()));
  ...
  for path in iter_paths {
    ...
    tar
      ...
      .with_context(|| format!("Unable to add file to tarball '{}'", path.display()))?;
  }
