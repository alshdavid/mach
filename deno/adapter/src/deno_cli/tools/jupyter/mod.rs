...
use crate::deno_cli::args::JupyterFlags;
use crate::deno_cli::ops;
use crate::deno_cli::tools::jupyter::server::StdioMsg;
use crate::deno_cli::tools::repl;
use crate::deno_cli::tools::test::create_single_test_event_channel;
use crate::deno_cli::tools::test::reporters::PrettyTestReporter;
use crate::deno_cli::tools::test::TestEventWorkerSender;
use crate::deno_cli::util::logger;
...
pub async fn kernel(
  ...
  let main_module = resolve_url_or_path("./$deno$jupyter.ts", cli_options.initial_cwd()).unwrap();
  ...
  let spec: ConnectionSpec = serde_json::from_str(&conn_file).with_context(|| {
    format!(
