...
use crate::deno_cli::cache::CACHE_PERM;
use crate::deno_cli::npm::cache_dir::mixed_case_package_name_decode;
use crate::deno_cli::util::fs::atomic_write_file;
use crate::deno_cli::util::fs::canonicalize_path_maybe_not_exists_with_fs;
use crate::deno_cli::util::fs::symlink_dir;
use crate::deno_cli::util::fs::LaxSingleProcessFsFlag;
...
use crate::deno_cli::npm::cache_dir::mixed_case_package_name_encode;
use crate::deno_cli::util::fs::copy_dir_recursive;
use crate::deno_cli::util::fs::hard_link_dir_recursive;
...
impl LocalNpmPackageResolver {
  pub fn new(
    ...
    Self {
      ...
      system_info,
      registry_read_permission_checker: RegistryReadPermissionChecker::new(fs, node_modules_folder),
    }
  }
...
async fn sync_resolution_with_fs(
  ...
  for package in &package_partitions.copy_packages {
    ...
    let destination_path =
      deno_local_registry_dir.join(get_package_folder_id_folder_name(&package_cache_folder_id));
  ...
  for package in package_partitions.iter_all() {
    ...
    for (name, dep_id) in &package.dependencies {
      ...
      if package.optional_dependencies.contains(name) && !dep.system.matches_system(system_info) {
