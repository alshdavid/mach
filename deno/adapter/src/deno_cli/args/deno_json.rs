...
pub fn deno_json_deps(config: &deno_config::ConfigFile) -> HashSet<JsrDepPackageReq> {
...
fn values_to_set<'a>(values: impl Iterator<Item = &'a String>) -> HashSet<JsrDepPackageReq> {
